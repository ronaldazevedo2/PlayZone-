...
class TelaControleAcesso extends StatefulWidget {
  ...
  const TelaControleAcesso({super.key, required this.aoNavegarParaAba});

  @override
  State<TelaControleAcesso> createState() => _TelaControleAcessoEstado();
}

class _TelaControleAcessoEstado extends State<TelaControleAcesso>
  ...
  void initState() {
    ...
    _animacaoLinhaScanner = Tween<double>(
      begin: 0.0,
      end: 1.0,
    ).animate(_controladorAnimacao);
  }
  ...
  void _simularLeituraQrCode() {
    final clientesDisponiveis = _estadoCentral.clientes
    ...
    if (clientesDisponiveis.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "Todos os clientes simulados já estão dentro da arena!",
          ),
    ...
    final clienteSorteado =
        clientesDisponiveis[Random().nextInt(clientesDisponiveis.length)];
          ...
          content: Column(
            ...
            children: [
              Container(
                ...
                child: CircleAvatar(
                  radius: 36,
                  backgroundImage: clienteSorteado.fotoUrl.isNotEmpty
                      ? NetworkImage(clienteSorteado.fotoUrl)
                      : null,
                  backgroundColor: const Color(0xFFE2E8F0),
                  child: clienteSorteado.fotoUrl.isEmpty
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          clienteSorteado.horarioPrevisto,
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF09398E),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      "Acesso liberado para ${clienteSorteado.nome}!",
                    ),
                    backgroundColor: const Color(0xFF0B7F38),
                  ),
                );
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  ...
                  colors: [Color(0xFF09398E), Color(0xFF051D55)],
                ),
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    // Navega diretamente para a aba sem estourar a rota atual com pop()
            ...
            if (acessosRecentes.isEmpty)
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _construirItemEntrada(entrada, ehEscuro);
                },
              ),
          ],
        ),
  ...
  Widget _construirItemEntrada(RegistroAcessoHistorico entrada, bool ehEscuro) {
    // Busca com fallback usando `where` para evitar exceção de construtor inconsistente
    final listaFiltrada = _estadoCentral.clientes.where(
      (c) => c.nome.toLowerCase() == entrada.nome.toLowerCase(),
    );

    final cliente = listaFiltrada.isNotEmpty
        ? listaFiltrada.first
        : ClienteArena(
            nome: entrada.nome,
            cpf: '000.000.000-00',
        ...
        child: Container(
          ...
          child: Row(
            children: [
              CircleAvatar(
                radius: 20,
                backgroundColor: const Color(0xFF09398E).withAlpha(25),
                child: Text(
                  entrada.nome
                      .substring(0, min(2, entrada.nome.length))
                      .toUpperCase(),
                  style: const TextStyle(
                    color: Color(0xFF09398E),
                    fontWeight: FontWeight.bold,
