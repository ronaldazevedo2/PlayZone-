...
class _TelaConfiguracoesEstado extends State<TelaConfiguracoes> {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Divider(height: 1, color: ehEscuro ? const Color(0xFF334155) : const Color(0xFFE2E8F0)),
                _construirItemAlternador(
          ...
          Center(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 12,
                color: ehEscuro ? const Color(0xFF64748B) : const Color(0xFF94A3B8),
              ),
            ),
          ),
        ],
  ...
  Widget _construirItemAlternador({
    ...
    return ListTile(
      leading: Icon(icone, color: ehEscuro ? const Color(0xFF3B82F6) : const Color(0xFF09398E)),
      title: Text(
        titulo,
        style: TextStyle(
          fontSize: 14,
    ...
    return ListTile(
      ...
      trailing: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          icon: Icon(Icons.keyboard_arrow_down, color: ehEscuro ? const Color(0xFF3B82F6) : const Color(0xFF09398E)),
          style: TextStyle(
            color: Theme.of(context).textTheme.bodyLarge?.color ?? const Color(0xFF1E293B),
            fontSize: 13,
            fontWeight: FontWeight.bold,
