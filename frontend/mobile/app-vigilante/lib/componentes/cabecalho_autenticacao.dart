      ...
      children: [
        ...
        Text(
          ...
          style: Theme.of(context).textTheme.headlineMedium?.copyWith(
                ...
                color: ehEscuro ? Colors.white : const Color(0xFF1E293B), // Cinza muito escuro/quase preto
              ),
        ...
        Padding(
          ...
          child: Text(
            ...
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: ehEscuro ? const Color(0xFF94A3B8) : const Color(0xFF64748B), // Cinza médio
                  height: 1.4,
                ),
            textAlign: TextAlign.center,
          ),
