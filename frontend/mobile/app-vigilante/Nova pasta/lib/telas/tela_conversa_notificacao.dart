...
class _TelaConversaNotificacaoEstado extends State<TelaConversaNotificacao> {
  ...
  Widget build(BuildContext context) {
    ...
    if (notificacao.id.isEmpty) {
      return const Scaffold(
        body: Center(child: Text("Notificação não encontrada")),
      );
    }

    return Scaffold(
      backgroundColor: const Color(0xFFF1F5F9), // Fundo levemente cinza do chat
      appBar: AppBar(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _construirBalaoMensagem(msg);
              },
            ),
          ),
  ...
  Widget _construirBalaoMensagem(MensagemChat msg) {
    final alinhamentoDireita = msg.enviadaPorMim;
    final corFundo = alinhamentoDireita ? const Color(0xFF0B7F38) : Colors.white;
    final corTexto = alinhamentoDireita ? Colors.white : const Color(0xFF1E293B);
