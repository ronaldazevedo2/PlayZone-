...
class _TelaBuscarEstado extends State<TelaBuscar> {
        ...
        children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: "Buscar por nome, CPF ou matrícula...",
            ...
            child: _resultadosFiltrados.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _construirItemResultado(resultado);
                    },
                  ),
          ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _construirItemLegenda(const Color(0xFF0B7F38), "LIBERADO"),
                _construirItemLegenda(const Color(0xFFF59E0B), "PENDENTE"),
                _construirItemLegenda(const Color(0xFF64748B), "LIVRE"),
              ],
            ),
          ),
        ],
  ...
  Widget _construirItemResultado(ClienteArena resultado) {
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _obterCorStatus(resultado.statusAcesso), width: 2),
              ),
              ...
              child: CircleAvatar(
                ...
                child: resultado.fotoUrl.isEmpty
                    ? Text(
                        resultado.nome.substring(0, min(2, resultado.nome.length)).toUpperCase(),
