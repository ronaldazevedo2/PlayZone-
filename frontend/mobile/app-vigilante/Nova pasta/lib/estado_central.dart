...
class EstadoCentral extends ChangeNotifier {
  ...
  bool cadastrarVigilante(String nome, String email, String matricula, String senha) {
    // Verifica se já existe o e-mail cadastrado
    final existe = _vigilantes.any((v) => v.email.toLowerCase() == email.trim().toLowerCase());
    if (existe) {
      return false;
    }
    _vigilantes.add(Vigilante(
